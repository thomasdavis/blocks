...
import { default as __fd_glob_34 } from "../content/docs/examples/meta.json?collection=meta"
...
export const meta = await create.meta("meta", "content/docs", {"meta.json": __fd_glob_31, "core-concepts/meta.json": __fd_glob_32, "getting-started/meta.json": __fd_glob_33, "examples/meta.json": __fd_glob_34, "specification/meta.json": __fd_glob_35, "tutorials/meta.json": __fd_glob_36, });