...
import { default as __fd_glob_2 } from "../content/docs/getting-started/meta.json?collection=meta"
...
export const docs = await create.doc("docs", "content/docs", {"index.mdx": __fd_glob_3, "core-concepts/entities.mdx": __fd_glob_4, "core-concepts/index.mdx": __fd_glob_5, "core-concepts/measures.mdx": __fd_glob_6, "core-concepts/signals.mdx": __fd_glob_7, "getting-started/configuration.mdx": __fd_glob_8, "getting-started/installation.mdx": __fd_glob_9, "getting-started/quick-start.mdx": __fd_glob_10, });

export const meta = await create.meta("meta", "content/docs", {"meta.json": __fd_glob_0, "core-concepts/meta.json": __fd_glob_1, "getting-started/meta.json": __fd_glob_2, });