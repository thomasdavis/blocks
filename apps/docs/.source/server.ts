...
import { default as __fd_glob_34 } from "../content/docs/core-concepts/meta.json?collection=meta"
import { default as __fd_glob_33 } from "../content/docs/getting-started/meta.json?collection=meta"
import { default as __fd_glob_32 } from "../content/docs/examples/meta.json?collection=meta"
...
import * as __fd_glob_18 from "../content/docs/core-concepts/signals.mdx?collection=docs"
import * as __fd_glob_17 from "../content/docs/core-concepts/semantics.mdx?collection=docs"
import * as __fd_glob_16 from "../content/docs/core-concepts/measures.mdx?collection=docs"
import * as __fd_glob_15 from "../content/docs/core-concepts/index.mdx?collection=docs"
import * as __fd_glob_14 from "../content/docs/core-concepts/entities.mdx?collection=docs"
import * as __fd_glob_13 from "../content/docs/getting-started/using-ai-effectively.mdx?collection=docs"
...
import * as __fd_glob_9 from "../content/docs/getting-started/database-storage.mdx?collection=docs"
...
import * as __fd_glob_6 from "../content/docs/examples/json-resume-themes.mdx?collection=docs"
import * as __fd_glob_5 from "../content/docs/examples/index.mdx?collection=docs"
import * as __fd_glob_4 from "../content/docs/examples/hr-recommendation-engine.mdx?collection=docs"
import * as __fd_glob_3 from "../content/docs/examples/blog-content-validator.mdx?collection=docs"
...
export const docs = await create.doc("docs", "content/docs", {"devtools.mdx": __fd_glob_0, "index.mdx": __fd_glob_1, "use-cases.mdx": __fd_glob_2, "examples/blog-content-validator.mdx": __fd_glob_3, "examples/hr-recommendation-engine.mdx": __fd_glob_4, "examples/index.mdx": __fd_glob_5, "examples/json-resume-themes.mdx": __fd_glob_6, "getting-started/ai-configuration.mdx": __fd_glob_7, "getting-started/configuration.mdx": __fd_glob_8, "getting-started/database-storage.mdx": __fd_glob_9, "getting-started/index.mdx": __fd_glob_10, "getting-started/installation.mdx": __fd_glob_11, "getting-started/quick-start.mdx": __fd_glob_12, "getting-started/using-ai-effectively.mdx": __fd_glob_13, "core-concepts/entities.mdx": __fd_glob_14, "core-concepts/index.mdx": __fd_glob_15, "core-concepts/measures.mdx": __fd_glob_16, "core-concepts/semantics.mdx": __fd_glob_17, "core-concepts/signals.mdx": __fd_glob_18, "specification/blocks-yml.mdx": __fd_glob_19, "specification/domain-model.mdx": __fd_glob_20, "specification/index.mdx": __fd_glob_21, "specification/migration.mdx": __fd_glob_22, "specification/sources.mdx": __fd_glob_23, "specification/store-api.mdx": __fd_glob_24, "specification/validators.mdx": __fd_glob_25, "tutorials/ci-cd-integration.mdx": __fd_glob_26, "tutorials/database-migration.mdx": __fd_glob_27, "tutorials/first-block.mdx": __fd_glob_28, "tutorials/index.mdx": __fd_glob_29, "tutorials/visual-testing.mdx": __fd_glob_30, });

export const meta = await create.meta("meta", "content/docs", {"meta.json": __fd_glob_31, "examples/meta.json": __fd_glob_32, "getting-started/meta.json": __fd_glob_33, "core-concepts/meta.json": __fd_glob_34, "specification/meta.json": __fd_glob_35, "tutorials/meta.json": __fd_glob_36, });