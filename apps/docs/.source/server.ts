...
import { default as __fd_glob_11 } from "../content/docs/core-concepts/meta.json?collection=meta"
...
import * as __fd_glob_6 from "../content/docs/examples/hr-recommendation-engine.mdx?collection=docs"
...
export const docs = await create.doc("docs", "content/docs", {"index.mdx": __fd_glob_0, "use-cases.mdx": __fd_glob_1, "core-concepts/entities.mdx": __fd_glob_2, "core-concepts/index.mdx": __fd_glob_3, "core-concepts/measures.mdx": __fd_glob_4, "core-concepts/signals.mdx": __fd_glob_5, "examples/hr-recommendation-engine.mdx": __fd_glob_6, "getting-started/configuration.mdx": __fd_glob_7, "getting-started/installation.mdx": __fd_glob_8, "getting-started/quick-start.mdx": __fd_glob_9, });

export const meta = await create.meta("meta", "content/docs", {"meta.json": __fd_glob_10, "core-concepts/meta.json": __fd_glob_11, "examples/meta.json": __fd_glob_12, "getting-started/meta.json": __fd_glob_13, });