...
export const meta = await create.meta("meta", "content/docs", {"meta.json": __fd_glob_11, "core-concepts/meta.json": __fd_glob_12, "getting-started/meta.json": __fd_glob_13, "examples/meta.json": __fd_glob_14, });