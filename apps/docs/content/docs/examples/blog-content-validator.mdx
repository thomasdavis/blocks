...
But seriously—if you're struggling with YAML, it's not you. It's probably
...
```
⚠ [domain] Missing humor or wit
→ Suggestion: Add personal anecdote or light-hearted observation

⚠ [domain] Tone is encyclopedic, not conversational
→ Suggestion: Use "you" and "I", ask questions, share experience

⚠ [domain] No reader engagement
→ Suggestion: Include relatable scenario or ask rhetorical questions
```
