...
**Visual Validators** (optional, screenshot-based):

*Deterministic (axe-core):*
- ✓ Color contrast passes WCAG AA (4.8:1)
- ✓ Heading hierarchy correct
- ✓ ARIA attributes valid

*AI Vision (GPT-4o):*
- ✓ [mobile] Text readable on all backgrounds
- ✓ [tablet] Visual hierarchy clear
- ✓ [desktop] Professional appearance maintained
- ⚠ [mobile] Section spacing could be more generous

## Visual Validation (Optional)

For enhanced visual quality checks, enable screenshot-based validation:

```yaml
validators:
  visual:
    - id: axe_accessibility
      run: "visual.axe.v1"
    - id: vision_analysis
...
- **Visual hierarchy** across viewports
- **Readability** and spacing
- **Layout integrity** at different screen sizes

See [Visual Validation guide](/docs/validators/visual-validation) for details.
